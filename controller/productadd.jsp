...
if(!request.getParameter("name").equals("") ){
	        ...
	        ProductDeleteQuery=con.prepareStatement("INSERT INTO product (ClassId, ProductName, Detail, Price, Stock, Url, Description, Size) VALUES (?,?,?,?,?,?,?,?)");
   ...
   out.println("location='../productadd.jsp';");
   out.println("</script>");

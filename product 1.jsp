...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="css/product 1.css">
...
<body style="background-color :#E8F5E9; ">
    ...
    <ul class="menu">
      ...
      <li><a href="product 1.jsp">後背包▾</a>
        <ul>
          <li><a href="product 2.jsp">側背包</a> </li>
...
<!-- <img src="image/bag1.jpg" style="border:2px black solid;" class="bag1" >
<div class="link-top2"></div>
<img src="image/bag2.jpg" style="border:2px black solid;" class="bag2" >
<div class="link-top3"></div> 
<img src="image/bag3.jpg" style="border:2px black solid;" class="bag3" >
<div class="link-top4"></div>
<img src="image/bag4.jpg" style="border:2px black solid;" class="bag4" >
...
<div class="link-top2"></div>
<div class="t1">
    <a href="product 1-1.html"  style="text-decoration:none;" ><h2 class="a1"><% out.print(rs.getString(3)); %></h2></a> 
    <div class="t-1">
...
<div class="link-top3"></div>
<div class="t2">
    <a href="product 1-2.html"  style="text-decoration:none;" ><h2 class="a1"><% out.print(rs.getString(3)); %></h2></a> 
    <div class="t-2">
        <pre style="font-size: 20px;" >  
          價格: <%out.print(rs.getString(6));%>
          顏色: <%out.print(rs.getString(10));%>
...
<div class="link-top4"></div>
<div class="t3">
    <a href="product 1-3.html"  style="text-decoration:none;" ><h2 class="a1"><% out.print(rs.getString(3)); %></h2></a> 
    <div class="t-3">
        <pre style="font-size: 20px;" >  
          價格: <%out.print(rs.getString(6));%>
          顏色: <%out.print(rs.getString(10));%>
...
<div class="link-top5"></div>
<div class="t4">
    <a href="product 1-4.html"  style="text-decoration:none;" ><h2 class="a1"><% out.print(rs.getString(3)); %></h2></a> 
    <div class="t-4">
        <pre style="font-size: 20px;" >  
          價格: <%out.print(rs.getString(6));%>
          顏色: <%out.print(rs.getString(10));%>

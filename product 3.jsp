...
<img src="image/bag10.jpg" style="border:2px black solid;" class="bag2" >
<div class="link-top3"></div>
<img src="image/bag11.jpg" style="border:2px black solid;" class="bag3" >
<div class="link-top4"></div>
<img src="image/bag12.jpg" style="border:2px black solid;" class="bag4" >
...
<div class="link-top2"></div>
<div class="t1">
    <a href="product 3-1.html"  style="text-decoration:none;" ><h2 class="a1"><% out.print(rs.getString(3)); %></h2></a> 
    <div class="t-1">
...
<div class="link-top2"></div>
<div class="t2">
    <a href="product 3-2.html"  style="text-decoration:none;" ><h2 class="a1"><% out.print(rs.getString(3)); %></h2></a> 
    <div class="t-2">
        <pre style="font-size: 20px;" >  
          價格: <%out.print(rs.getString(6));%>
          顏色: <%out.print(rs.getString(10));%>
...
<div class="link-top2"></div>
<div class="t3">
    <a href="product 3-3.html"  style="text-decoration:none;" ><h2 class="a1"><% out.print(rs.getString(3)); %></h2></a> 
    <div class="t-3">
        <pre style="font-size: 20px;" >  
          價格: <%out.print(rs.getString(6));%>
          顏色: <%out.print(rs.getString(10));%>
...
<div class="link-top2"></div>
<div class="t4">
    <a href="product 3-4.html"  style="text-decoration:none;" ><h2 class="a1"><% out.print(rs.getString(3)); %></h2></a> 
    <div class="t-4">
        <pre style="font-size: 20px;" >  
          價格: <%out.print(rs.getString(6));%>
          顏色: <%out.print(rs.getString(10));%>
